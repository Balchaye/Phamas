    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Keto Med Pharmaceutical & Medical Supply Whole Sale', 'Manage Existing Medicine Stock');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <!-- &emsp;<button class="btn btn-warning font-weight-bold" onclick="searchMedicineStock('', 'EXPIRY_TIME');">Expired After Six Month And Less</button> -->
            ...
            <div class="table-responsive">
                ...
                <tbody id="medicines_stock_div">
                  <?php
                    ...
                    // else if(isset($_GET['exptime']))
                    //   echo "<script>searchMedicineStock('', 'EXPIRY_TIME');</script>";
                    else
