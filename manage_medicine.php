    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Keto Med Pharmaceutical & Medical Supply Whole Sale', 'Manage Existing Medicine');
        ?>
        <!-- header section end -->
            ...
            <div class="table-responsive">
            	<table class="table table-bordered table-striped table-hover">
                    ...
                    <th style="width: 30%;">Generic Name</th>
            				<th style="width: 20%;">Total Quantity Purchased Untile now</th>
