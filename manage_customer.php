    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('handshake', 'Keto Med Pharmaceutical & Medical Supply Whole Sale', 'Manage Existing Customer');
        ?>
        <!-- header section end -->
          ...
          <div class="col col-md-12 table-responsive">
            <div class="table-responsive">
            	<table class="table table-bordered table-striped table-hover">
                    ...
                    <th style="width: 13%;">Institutiton Owner</th>
                    <th style="width: 13%;">TIN Number</th>
                    <th style="width: 13%;">Institutiton Level</th>
