    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('clipboard', 'Keto Med Pharmaceutical & Medical Supply Whole Sale', 'Create New Invoice');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            <div class="col col-md-0 form-group">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="customers_address">Region :</label>
              <input id="customers_address" type="text" class="form-control" name="customers_address" placeholder="Region" disabled>
            </div>
            <!-- how can i get the zone and use it  -->
            <!-- <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="customers_zone">Zone :</label>
              <input id="customers_zone" type="text" class="form-control" name="customers_zone" placeholder="Zone" disabled>
            </div> -->
            <div class="col col-md-2 form-group">
            ...
            <!-- the starting of contact number coding -->
            <div class="col col-md-2 form-group">
          ...
          <div class="row col col-md-12">
            <div class="row col col-md-12 font-weight-bold">
              ...
              <div class="col col-md-1">Batch.Qty.</div>
          ...
          <div class="row col col-md-12">
            <div class="col col-md-0 form-group"></div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Total Quantity:</label>
              <input type="text" class="form-control" value="0" id="total_quantity" disabled>
            </div>
            <div class="col col-md-2 form-group float-right">
