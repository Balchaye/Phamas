...
<html lang="en" dir="ltr">
  ...
  <!-- this will be the important thing to do some futures on this project 
     Keto Med companies that will be used by the development of the system that solve 
     the problem of the companies that rise during the companies working time 
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('bar-chart', 'Keto Med Pharmaceutical & Medical Supply Whole Sale', 'Add New Purchase');
        ?>
        <!-- header section end -->

        <!-- form content 
       tbis the form that will be filed by the system during the data intery to the system-->
        <!-- let us start from the upper one  -->
       <div class="row">
          <!-- manufacturer details content 
         the above content that will filled -->
          ...
          <!-- The end of the upper format -->
          <!-- Supplier details content starting form -->
          <div class="row col col-md-12">
